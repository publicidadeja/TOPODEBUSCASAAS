<nav x-data="{ open: false, sidebarOpen: false }" class="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 shadow-sm">
            ...
            <div class="flex items-center">
                ...
                <div class="flex-shrink-0 flex items-center px-4">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="ml-2 text-lg font-google-sans text-gray-800 dark:text-gray-200">TopoSaaS</span>
                    </a>
                </div>
            ...
            <div class="flex items-center">
                ...
                <div class="relative mr-4">
                    <button class="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200">
                        <i class="material-icons-outlined text-xl text-gray-600 dark:text-gray-300">notifications</i>
                    </button>
                </div>
                ...
                <div class="relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center px-3 py-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200">
                                <img class="h-8 w-8 rounded-full object-cover" 
                                     src="{{ Auth::user()->profile_photo_url ?? 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name) }}" 
                                     alt="{{ Auth::user()->name }}">
                                <span class="ml-2 text-sm font-google-sans text-gray-700 dark:text-gray-300">
                                    {{ Auth::user()->name }}
                                </span>
                            </button>
                        </x-slot>
    ...
    <div x-show="sidebarOpen" 
        ...
        <!-- Sidebar Content -->
        <div class="fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-900 shadow-lg">
...
<!-- Add required styles in your layout file or CSS -->
<style>
    ...
    .nav-link-active {
        @apply bg-blue-50 text-blue-700 dark:bg-blue-900/50 dark:text-blue-200;
    }
